...
from awslabs.amazon_sns_sqs_mcp_server.sns import (
    ...
    register_sns_tools,
    set_archive_policy_override,
    remove_archive_policy_override,
)
...
class TestSNSTools:
    ...
    def test_set_archive_policy_override(self):
        """Test set_archive_policy_override function."""
        # Mock FastMCP
        mock_mcp = MagicMock()
        ...
        # Call the function
        set_archive_policy_override(mock_mcp, mock_sns_client_getter, "")
        ...
        # Verify set_topic_attributes was called with correct parameters
        expected_policy = json.dumps({"MessageRetentionPeriod": 30})
        mock_sns_client.set_topic_attributes.assert_called_with(
            TopicArn="arn:aws:sns:us-east-1:123456789012:test-topic",
            AttributeName="ArchivePolicy",
            AttributeValue=expected_policy
        )
        
        # Verify result
        assert result["success"] is True
        assert result["topic_arn"] == "arn:aws:sns:us-east-1:123456789012:test-topic"
        ...
        # Test with exception
        mock_sns_client.set_topic_attributes.side_effect = Exception("Test exception")
        result = decorated_func(
            topic_arn="arn:aws:sns:us-east-1:123456789012:test-topic",
            retention_period_days=30,
            region="us-west-2"
    ...
    def test_remove_archive_policy_override(self):
        """Test remove_archive_policy_override function."""
        # Mock FastMCP
        mock_mcp = MagicMock()
        ...
        # Call the function
        remove_archive_policy_override(mock_mcp, mock_sns_client_getter, "")
        ...
        assert result["success"] is True
        assert result["topic_arn"] == "arn:aws:sns:us-east-1:123456789012:test-topic"
        assert result["message"] == "Archive policy removed successfully"
